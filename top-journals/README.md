...
|---|---|---|
| [`nature.md`](./nature.md) | **Nature** family — Nature, Nature Machine Intelligence, Nature Medicine, Nature Computational Science, Nature Methods, Nature Biotechnology, Nature Communications, Nature Human Behaviour, Nature Biomedical Engineering, Nature Genetics, Nature Reviews (Cancer, Psychology, Bioengineering, …), Communications Psychology, Nature Health, npj Digital Medicine, npj Computational Materials, Humanities & Social Sciences Communications, plus **PNAS** + **NEJM / NEJM AI / Lancet / JAMA** items appended for related analysis papers, etc. | **191** |
...
> - **Pass 4** (+43): **analysis / probing / cognitive-impact / clinical-safety / policy-perspective** papers — covering (i) **cognitive & behavioural analysis** (ChatGPT creativity, divergent thinking, empathy penalty, sensorimotor grounding gap, dual-process LLMs, EI tests, brain-attention alignment by Kumar Nature Comm 2024, social-identity bias, LLM as synthetic subject limits); (ii) **PNAS bias / moral / cognition papers** (amplified moral biases, cognitive dissonance, implicit IAT bias, personality social-desirability, AI-AI evaluator bias, moral stereotyping by culture); (iii) **clinical safety / red-team / equity audits** (npj DM racial bias in psychiatry, cognitive bias in clinical LLMs, ChatGPT medicine red-teaming, GPT-5 sociodemographic bias, unsafe answers to patient questions, AI misinformation harms to students, foundation-models-as-social-experiment ethics framework); (iv) **major medical reviews & policy** (NM 2025 GAI in medicine, LLM-assisted SR of 4609 clinical LLM studies, "AI-induced never-skilling", consumer LLM medical-advice RCT, Nature Reviews Cancer agents, Nature Health global health, NEJM Sounding Board, NEJM "Compared with What?", NEJM AI CHAIO role, AI scribe burden, NAM Code of Conduct, SAIL 2025 year-in-review, Lancet DH STANDING Together, environmental cost, TRAIN initiative, Lancet Public Health agenda, LMIC roadmap, JAMA Summit Report).
>
